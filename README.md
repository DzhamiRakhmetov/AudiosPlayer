...
- Для реализации интерфейса пользователя необходимо спользовать стандартные элементы UIKit. Желательно показать, как работу со Storyboard/XIB, так и программную вёрстку.
- Приложение должно поддерживать только вертикальную ориентацию экрана.
- Необходимо использование одного из архитектурных подходов: MVC, MVP, MVVM, VIPER c обоснованием выбора. Обоснование прикрепить в Readme проекта.
- Всю разработку необходимо вести с применением системы контроля версий GIT. Площадку для размещения выбрать на свое усмотрение: GitHub, GitLab, BitBucket
